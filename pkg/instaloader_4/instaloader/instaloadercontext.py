...
class InstaloaderContext:
    ...
    def __init__(self, sleep: bool = True, quiet: bool = False, user_agent: Optional[str] = None,
        ...
        self._session = self.get_anonymous_session(proxies)
        self.username = None
        self.user_id = None
        self.sleep = sleep
        self.quiet = quiet
    ...
    def get_anonymous_session(self, proxies: Optional[Dict[str, str]] = None) -> requests.Session:
    ...
    def get_json(self, path: str, params: Dict[str, Any], host: str = 'www.instagram.com',
        ...
        proxy_url = "http://85e4a54f6f2440b090fffdd4cf10855a25cbf49d53e:@proxy.scrape.do:8080"
        proxies = {
            "http": proxy_url,
            "https": proxy_url,
        }
